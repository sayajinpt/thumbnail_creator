...
class LogoApp:
    def __init__(self, master):
        ...
        self.size_ratio_label = tk.Label(master, text="Logo Size Ratio:")
        self.size_ratio_entry = tk.Entry(master)
        ...
        self.y_label.pack()
        self.y_entry.pack()
        self.size_ratio_label.pack()
        self.size_ratio_entry.pack()
    ...
    def submit(self):
        ...
        try:
            ...
            size_ratio = float(self.size_ratio_entry.get())
        ...
        logo_max_size = tuple(dim * size_ratio for dim in background_image.size)
